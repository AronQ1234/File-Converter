export default function About() {
    return (
        <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
            <p>
                Introducing FFC(free file converter), the ultimate multimedia conversion powerhouse that empowers you to transform images,
            ...
            <div className="space-y-2">
                ...
                <p>
                    ...
                    convert formats, we have got you covered. From JPEG to PNG, and everything in between, effortlessly
            ...
            <div className="space-y-2">
                ...
                <p>
                    ...
                    You can convert as many images, audio files, and videos as your heart desires, and it will not cost you a
                    dime.
                </p>
            </div>
            ...
            <div className="space-y-2">
                ...
                <p>
                    Access FFC from any device with an internet connection. Whether you are on your computer, tablet,
            ...
            <div className="space-y-2">
                ...
                <p>
                    We are committed to staying ahead of the curve. Expect regular updates and new features to keep your
